...
for trait in ["O","C","E","A","N"]:
    models[trait] = joblib.load("Models/MPbig/SVM_Big_conc_"+trait+".pkl")
print("Models loaded.")
...
for username in usernames:
    ...
    for trait in ["O","C","E","A","N"]:
        ...
        print("\tScore for",trait,"is:",str(np.mean(np.array(preds)))[0:5])
...
filename = "personality_predictions1_big.csv"
fp = open(filename,"w")
for elem in outfile:
    fp.write(elem+"\n")
fp.close()
